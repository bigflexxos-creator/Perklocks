...
def test_global_blacklist():
    ...
    ({"sport":"MLB","market":"Judge Over 0.5 Hits","lock_score":92,"book_odds":-130}, True, "Odds dead-zone -130"),
    # Should PASS (return None)
    ({"sport":"MLB","market":"Judge Over 0.5 Hits","lock_score":94,"book_odds":-200}, False, "Hits pass"),
    ({"sport":"MLB","market":"Cole Over 6.5 Strikeouts","lock_score":95,"book_odds":-115}, True, "Strikeouts at -115 hits dead-zone"),
